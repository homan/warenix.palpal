...
public class ConversationListController extends ListViewController {

	public ConversationListController(Activity context, int resourceId) {
	...
	public ListViewAdapter setupListViewAdapter(Context context) {
		...
		ConversationListAdapter adapter = new ConversationListAdapter(context);
		return adapter;
	}

	public void stop() {
		((ConversationListAdapter) listAdapter).stop();
	}

	public void refresh(long statusId) {
		((ConversationListAdapter) listAdapter).refresh(statusId);
	}
