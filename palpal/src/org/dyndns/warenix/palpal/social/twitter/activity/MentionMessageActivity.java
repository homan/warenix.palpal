...
import org.dyndns.warenix.palpal.twitter.mentionMessage.MentionMessageListController;
...
public class MentionMessageActivity extends Activity {

	public static final String BUNDLE_PAGE_NO = "page_no";
	MentionMessageListController controller;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		controller = new MentionMessageListController(this, R.id.listView1);
