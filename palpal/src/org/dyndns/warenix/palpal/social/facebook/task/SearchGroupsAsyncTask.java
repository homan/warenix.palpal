...
public class SearchGroupsAsyncTask extends
		AsyncTask<Object, Void, FacebookException> {

	SearchGroupsListener listener;
	ArrayList<FacebookPost> friendList;

	public SearchGroupsAsyncTask(SearchGroupsListener listener) {
	...
	protected FacebookException doInBackground(Object... params) {
		...
		String responseString = FacebookAPI.getUserGroups(userName, parameters);
	...
	protected void onPostExecute(FacebookException e) {
		if (e != null) {
			listener.onGroupLoadedError(e);
		}

		if (listener != null) {
			listener.onGroupsLoaded(friendList);
		}
	}

	public interface SearchGroupsListener {
